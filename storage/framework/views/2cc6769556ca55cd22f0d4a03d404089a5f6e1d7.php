<?php $__env->startSection('content'); ?>
    ...
    <?php if (\Illuminate\Support\Facades\Blade::check('installed', 'game-roulette|game-american-roulette')): ?>
    <div class="container pt-3 pb-3">
        <hr class="bg-primary">
    </div>
            ...
            <div class="col-lg-6">
                <div class="bg-secondary p-4">
                    ...
                    <ul class="list-inline">
                        ...
                        <li><i class="fas fa-thumbs-up p-2"></i> <?php echo e(__('Trio')); ?></li>
                    ...
                    <a href="<?php echo e(route('games.roulette.show')); ?>" class="btn btn-primary"><?php echo e(__('Play European Roulette')); ?></a>
                    <?php endif; ?>
                    <?php if (\Illuminate\Support\Facades\Blade::check('installed', 'game-american-roulette')): ?>
                    <a href="<?php echo e(route('games.american-roulette.show')); ?>" class="btn btn-primary"><?php echo e(__('Play American Roulette')); ?></a>
                    <?php endif; ?>
                </div>
            </div>
